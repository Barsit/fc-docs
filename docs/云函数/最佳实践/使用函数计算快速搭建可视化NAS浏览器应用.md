...
6. 在刚创建的文件系统的**操作**列，单击**挂载**，然后复制挂载点地址备用。
  ...
  ![image.png](../../../assets/2712038-001-aa7bd64b11.png)
...
1. 在[**fc-nas-filemgr应用模板**](https://fcnext.console.aliyun.com/applications/create?template=fc-nas-filemgr)页面，按如下说明配置必要参数，其他参数请根据实际业务配置或使用默认参数。
  ...
  **重要**
  ...
  | **角色名称** | **AliyunFCServerlessDevsRole** | - 首次登录用户，需要单击**前往授权**配置角色权限。<br>![image.png](../../../assets/2712038-002-86e2ab92e0.png)<br>- 如果您的角色名称已有相关权限，则无需设置。<br>![image.png](../../../assets/2712038-003-e40223abd6.png) |
...
2. 单击**创建并部署默认环境**。
  ...
  ![image.png](../../../assets/2712038-004-552a6a4370.png)
...
2. 单击**访问域名**右侧的域名地址，跳转至Web版的**NAS浏览器**页面，体验管理NAS文件系统。
  ...
  **重要**
  ...
  1. 新建文件夹
    ...
    ![image](../../../assets/2712038-005-5b901a929c.png)
  2. 上传文件
    ...
    **重要**
    ...
    ![image](../../../assets/2712038-006-2003eaab4a.png)
    
    上传完成后，您还可以点击页面上方根目录左侧的![image](../../../assets/2712038-007-5418b5cb1f.png)图标刷新，查看文件。
    
    ![image](../../../assets/2712038-008-140713cc59.png)
