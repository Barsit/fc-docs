...
![image](../../../assets/2803721-001-f69f26be61.svg)
...
2. 在应用页面，单击**创建应用**，选择**通过模板创建应用**，在下方模板选择区域，单击**人工智能**页签，找到**语音克隆生成GPT-SoVITS，**光标移至该卡片，单击**立即创建**。
  ...
  ![image](../../../assets/2803721-002-d510059b40.png)
...
![image.png](../../../assets/2803721-003-e55035d3df.png)

1. 等待语音合成之后，可以单击播放。

![image.jpg](../../../assets/2803721-004-431df5ec06.jpg)
...
3. 使用Postman调用语音合成API。
  ...
  2. 语音生成结束后，音频将出现在下方返回结果中。您可以试听或保存音频。
    ...
    ![image](../../../assets/2803721-012-e003261a03.png)
...
1. 数据预处理。准备一个较长的您需要克隆的原始声音，单击**数据预处理**，输入您需要上传的语音文件，单击**开始数据预处理**。
  ...
  ![image.png](../../../assets/2803721-013-12f6aab385.png)

1. 微调文本。单击**训练语音文本校对**，调整原始文本的内容。
  
  ![image.png](../../../assets/2803721-014-2bbb58df55.png)
2. 开始训练，单击**模型微调**，开启SoVITS训练和GPT训练。训练后的模型将存储在NAS下的GPT_weights和SoVITS_weights文件夹内。
  
  ![image.png](../../../assets/2803721-015-2591028d2b.png)
3. 训练完之后，在**语音克隆&&推流**页签，刷新和选择自己训练的模型，再体验合成语音。
  
  ![image.png](../../../assets/2803721-016-8b375d3b3b.png)
...
2. 在**应用**页面，找到您部署的应用，单击右侧**操作**列下的**删除**，根据页面提示删除该应用。
  ...
  ![image.png](../../../assets/2803721-017-000b572f8b.png)

### **删除模型管理器使用的NAS。**

1. 登录[文件存储控制台](https://nasnext.console.aliyun.com/overview)，在**文件系统列表**页面，切换到华东1（杭州）地域，找Alibab-Fc开头到目标文件系统，在**操作**列，选择![image.png](../../../assets/2803721-018-59c73ab6d7.png)**>删除**。
  ...
  **说明**
  ...
  ![image](../../../assets/2803721-019-774b1c1339.png)
