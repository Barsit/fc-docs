...
1. 在函数详情页面的**代码**页签，单击**测试函数**右侧的![image.png](../../../assets/2851986-001-51d4269d35.png)图标，从下拉列表中，选择**配置测试参数**。
  
  在**配置测试参数**面板，选择**创建新测试事件**或**编辑已有测试事件**，输入参数，点击**确定**。
  
  ![image](../../../assets/2851986-002-22a931c75e.png)
...
2. 单击**测试函数**即可完成测试。
  ...
  ![image](../../../assets/2851986-003-792a4ec0f5.png)
3. 检查收件人的邮箱中是否收到邮件。
...
5. 单击目标业务流程名称，在其展开的**通用**节点上右键单击并选择**函数计算**。在创建节点弹出框中输入节点名称并单击**确认**按钮，完成**函数计算**节点的创建。
  ...
  ![image](../../../assets/2851986-004-9a45be00b6.png)
6. 设置函数计算节点参数。
  
  ![image](../../../assets/2851986-005-f2e3a5d24f.png)
...
7. （可选）调试函数计算节点。节点配置完成后，您可单击![运行](../../../assets/2851986-006-291d145243.png)图标，为代码变量赋值常量进行调试运行，测试节点代码逻辑是否正确。
...
1. 保存并提交节点。
  ...
  单击工具栏中的![保存](../../../assets/2851986-007-cf01791bc6.png)、![提交](../../../assets/2851986-008-dfa58248a8.png)图标，保存并提交节点。提交节点时，请根据提示输入变更描述，并根据需要选择是否进行代码评审及冒烟测试。
