...
![image](../../../assets/2880292-001-a9c24edd3c.png)
...
1. 在搜索栏输入`QWQ`进行搜索，单击基于**Qwen-QwQ 推理模型构建AI聊天助手**，进入**模板详情**页，单击**立即部署**。
  ...
  ![image](../../../assets/2880292-002-855c4a82f1.png)
  
  ![image](../../../assets/2880292-003-6f0cb83925.png)
2. 选择**地域**，单击**部署项目**，在**项目资源预览**对话框中，您可以看到相关的计费项，详情请见[计费涉及的产品](https://help.aliyun.com/zh/cap/product-overview/billing-overview#title-z1y-ai5-gmw)。单击确认部署，部署过程大约持续 10 分钟左右，状态显示**已部署**表示部署成功。
  ...
  **说明**
  ...
  ![image](../../../assets/2880292-004-29361a3f9c.png)
  
  ![image](../../../assets/2880292-005-bb57c3023d.png)

### 3. 验证应用

部署完毕后，点击**Open-WebUI**服务，在**访问地址**内找到**公网访问**单击访问。在OpenWebUI界面体验QwQ模型进行对话。

![image](../../../assets/2880292-006-89d6f6b2f8.png)
...
1. 选择模型QwQ-32B-GGUF，目前仅支持杭州地域。
  ...
  ![image](../../../assets/2880292-007-722bbe5f0b.png)
2. 单击**资源配置**，QwQ-32B-GGUF推荐使用 Ada 系列，可直接使用默认配置。您可以根据业务诉求填写需要的卡型及规格信息。
  
  ![image](../../../assets/2880292-008-50438a8596.png)
3. 单击**预览并部署**，在**服务资源预览**对话框中，您可以看到相关的计费项，详情请见[计费涉及的产品](https://help.aliyun.com/zh/cap/product-overview/billing-overview#title-z1y-ai5-gmw)。单击**确认部署**，该阶段需下载模型，预计等待10~30分钟即可完成。
  ...
  ![image](../../../assets/2880292-009-429deaa09d.png)
  
  ![image](../../../assets/2880292-010-78e395b705.png)

### 3. 验证模型服务

单击**调试**，即可测试和验证相关模型调用。

![image](../../../assets/2880292-011-4a0a736e13.png)

![image](../../../assets/2880292-012-84443b0943.png)

在本地命令行窗口中验证模型调用。

![image](../../../assets/2880292-013-61304a3324.png)

### 4. 第三方平台 API 调用

您可以选择在[Chatbox](https://web.chatboxai.app/)等其他第三方平台中验证和应用模型调用，以下以Chatbox为例。

![image](../../../assets/2880292-014-1af4edfdf6.png)

![image](../../../assets/2880292-015-96fe6a7a6f.png)
