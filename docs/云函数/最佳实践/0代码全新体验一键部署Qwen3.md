...
![image](../../../assets/2883472-001-32268ba13d.png)
...
![image](../../../assets/2883472-002-2f169d6ae6.png)
...
![image](../../../assets/2883472-003-75e7778278.png)

### 2. 基于模板部署项目

1. 在搜索栏输入`Qwen3`进行搜索，单击**基于 Qwen3 构建AI 聊天助手**，进入**模板详情**页，单击**立即部署**。
  
  ![image](../../../assets/2883472-004-61ff5099ec.png)
  
  ![image](../../../assets/2883472-005-5546ef21a4.png)
2. 选择**地域**，单击**部署项目**，在**项目资源预览**对话框中，您可以看到相关的计费项，详情请见[计费说明](https://help.aliyun.com/zh/functioncompute/what-is-a-serverless-development-platform#c6d676070dsid)。单击确认部署，部署过程大约持续 10 分钟左右，状态显示**已部署**表示部署成功。
  ...
  **说明**
  ...
  ![image](../../../assets/2883472-006-bf4bd48b9f.png)
  
  ![image](../../../assets/2883472-007-a44ff55b5f.png)

### 3. 验证应用

部署完毕后，点击**Open-WebUI**服务，单击自定义域名的**公网访问地址**进行访问。

![image](../../../assets/2883472-008-36b163f5c0.png)

![image](../../../assets/2883472-009-94058cb063.png)

## 删除项目

1. **进入项目详情**>**点击删除**，会进入到删除确认对话框。
  
  ![image](../../../assets/2883472-010-1c005fa747.png)
2. 您可以看到要删除的资源。默认情况下，`Function AI`会删除项目下的所有服务。如果您希望保留资源，可以**取消勾选**指定的服务，删除项目时只会删除**勾选**的服务。
  
  ![image](../../../assets/2883472-011-0a7d41ad9f.png)
