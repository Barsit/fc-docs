...
3. 在**创建应用**页面，设置以下配置项，然后单击**创建应用**。
  ...
  | **Access Token** | ModelScope的访问令牌。ModelScope账号与阿里云账号绑定后，在ModelScope官网首页获取。<br>![image](../../../assets/2699361-001-865b4d72ae.png) | 57cc1b0a-08e8-4224-****** |
...
1. 在应用页面，点击域名地址，访问LLM应用。
  ...
  ![image](../../../assets/2699361-002-c6df24da0c.png)
2. 输入文本信息，然后单击**Submit**，您可以看到模型的回答结果。
  
  ![image.png](../../../assets/2699361-003-a1429fc8b9.png)
