...
2. 单击![image](../../../assets/2924002-001-de2f5066dc.png)，然后在**settings**对话框，勾选**Enable Dev mode Options**复选框开启开发者模式。
  
  ![image](../../../assets/2924002-002-bf4b59d179.png)
...
2. 在函数详情页面，选择**配置**页签，单击**实例配置**区域右侧的**编辑**，在**实例配置**面板，开启Initializer回调程序，设置**超时时间**为600s，选择**执行指令**，然后在代码输入框填写上一步[制作的预热脚本](#97cec55cf9mlh)。
  ...
  ![image](../../../assets/2924002-003-563ec5fc75.png)
3. 选择**弹性配置**页签，在下方**弹性策略**区域单击**配置**，在**配置弹性策略**面板，设置**最小实例数**为1，然后单击**确定**。
  
  ![image](../../../assets/2924002-004-eb6195db0b.png)
