...
1. 执行以下命令克隆测试函数`sync-test`。
  ...
  ![image](../../../assets/2513761-001-6d72decf64.png)
2. 修改工作目录下的`cn-hangzhou_sync-test.yaml`文件，函数名称修改为`sync-clone`，然后在代码目录下执行以下命令部署函数。
  ...
  执行完成后，您可以登录[函数计算控制台](https://fcnext.console.aliyun.com)查看已克隆的函数。![clone-func-result](../../../assets/2513761-002-b609d189f1.png)
