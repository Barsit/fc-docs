...
![image](../../../assets/2666020-001-1ea9a6de3f.svg)
...
3. 单击右上角的**编辑**，在编辑自定义域名页面，设置以下配置项，然后单击**保存**。
  ...
  1. **认证方式**选择为**JWT 认证**。
    ...
    ![image.png](../../../assets/2666020-002-49f064af1e.png)
  2. 配置JWKS。
    ...
    ![image](../../../assets/2666020-003-08c61fa222.png)
    
    ![image](../../../assets/2666020-004-87061e75c7.png)
  ...
  3. 配置JWT Token。
    ...
    ![image.png](../../../assets/2666020-005-ce4e1ae70d.png)
  4. 配置JWT Claim转换。
    
    选择透传给函数的参数所在位置、参数原始名称和参数透传给函数之后的名称。映射参数位置支持Header、Cookie、Query参数（GET）和表单参数（POST）。
    
    ![image.png](../../../assets/2666020-006-b058dce08c.png)
...
2. 使用Postman工具验证自定义域名是否可以正常访问。
  ...
  3. 单击**Send**，查看返回信息。![image.png](../../../assets/2666020-007-68850b0093.png)`nametofunction`为Claim透传给函数后的名称。
