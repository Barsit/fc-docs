...
![image](../../../assets/2513544-001-175b129968.svg)
...
![image](../../../assets/2513544-002-0441928fc4.svg)
...
![image](../../../assets/2513544-003-7b709c7d11.svg)
...
![image](../../../assets/2513544-004-2265137f40.svg)
...
3. 在函数详情页，选择**日志**页签，然后在**调用请求**页签，单击目标请求行右侧**操作**列的**高级日志**。
  ...
  此外，您还可以根据Start/End日志中的RequestId查询请求的日志信息。如果用户日志中没有RequestId，可以单击该日志中的![db_lifecycle_log_context](../../../assets/2513544-005-0befd50dd3.png)图标获取上下文日志。
