...
3. 在弹出的对话框，根据提示和实际场景，选择**任务函数**类型，然后单击**创建{title}**。
4. 在**创建{title}**页面，配置以下配置项，然后单击**创建**。
...
![image](../../../assets/2786854-001-ed56eb2733.png)
...
1. 在**函数详情**页，可以在**代码**页签修改函数代码，如果左边的分支显示有调整（图示中①），需要先**部署代码**让修改的代码生效，再单击**测试函数**。
  ...
  ![image](../../../assets/2786854-002-326824102e.png)
2. 也可以将写好的代码导出备份，也可以重新上传代码进行部署。
  
  ![image](../../../assets/2786854-003-35edc5d5cd.png)
  
  ![image](../../../assets/2786854-004-07f257a49c.png)
...
- 除控制台外，函数计算还支持通过API发起异步任务，详情请参见[调用函数](https://help.aliyun.com/zh/functioncompute/fc/developer-reference/api-fc-2023-03-30-invokefunction)。
