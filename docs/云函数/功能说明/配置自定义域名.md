...
![image](../../../assets/2513616-001-67b12ac0be.svg)
...
| **加密套件** | 选择TLS加密算法套件，如果不配置，默认选择全部加密套件。取值说明如下：<br>- **全部加密套件，兼容性较高，安全性较低**：选择全部加密套件。函数计算支持的加密套件列表请参见[强加密和弱加密套件列表](#ef589767a4pwa)。<br>- **协议版本的自定义加密套件、请谨慎选择，避免影响业务**：选择部分支持的加密套件。下拉列表中显示所有加密套件，您可以单击加密套件右侧的![delete](../../../assets/2513616-002-16afd036f5.png)图标，删除安全性较弱的弱加密套件，保留您选择的TLS协议版本支持的加密套件。<br>**<br>**重要**<br>- 请谨慎选择自定义加密套件，确保服务端和客户端套件的正确匹配。<br>- 关于TLS协议版本和其支持的加密套件，请参见[TLS协议版本与加密套件对应关系](#8892fce989w69)。<br>- 函数计算对加密套件的命名使用RFC命名规范。同一个加密套件，使用不同命名规范的命名会存在差异。关于RFC和OpenSSL命名的加密套件名称差异点，请参见[RFC与OpenSSL加密套件命名对照表](#4a8d14ff82tff)。 |
...
下表中![支持](../../../assets/2513616-003-20c9c60fe8.png)表示TLS协议版本支持该加密套件，![not-support](../../../assets/2513616-004-1939a46db9.png)表示TLS协议版本不支持该加密套件。

展开查看TLS协议版本与加密套件对应关系。

| **加密套件** | **TLS 1.0** | **TLS 1.1** | **TLS 1.2** | **TLS 1.3** |
| --- | --- | --- | --- | --- |
| TLS_RSA_WITH_3DES_EDE_CBC_SHA | ![not-support](../../../assets/2513616-005-1939a46db9.png) | ![not-support](../../../assets/2513616-006-1939a46db9.png) | ![not-support](../../../assets/2513616-007-1939a46db9.png) | ![not-support](../../../assets/2513616-008-1939a46db9.png) |
| TLS_RSA_WITH_AES_128_CBC_SHA | ![not-support](../../../assets/2513616-009-1939a46db9.png) | ![not-support](../../../assets/2513616-010-1939a46db9.png) | ![支持](../../../assets/2513616-011-20c9c60fe8.png) | ![not-support](../../../assets/2513616-012-1939a46db9.png) |
| TLS_RSA_WITH_AES_256_CBC_SHA | ![not-support](../../../assets/2513616-013-1939a46db9.png) | ![not-support](../../../assets/2513616-014-1939a46db9.png) | ![支持](../../../assets/2513616-015-20c9c60fe8.png) | ![not-support](../../../assets/2513616-016-1939a46db9.png) |
| TLS_RSA_WITH_AES_128_GCM_SHA256 | ![not-support](../../../assets/2513616-017-1939a46db9.png) | ![not-support](../../../assets/2513616-018-1939a46db9.png) | ![支持](../../../assets/2513616-019-20c9c60fe8.png) | ![not-support](../../../assets/2513616-020-1939a46db9.png) |
| TLS_RSA_WITH_AES_256_GCM_SHA384 | ![not-support](../../../assets/2513616-021-1939a46db9.png) | ![not-support](../../../assets/2513616-022-1939a46db9.png) | ![支持](../../../assets/2513616-023-20c9c60fe8.png) | ![not-support](../../../assets/2513616-024-1939a46db9.png) |
| TLS_ECDHE_ECDSA_WITH_AES_128_CBC_SHA | ![not-support](../../../assets/2513616-025-1939a46db9.png) | ![not-support](../../../assets/2513616-026-1939a46db9.png) | ![not-support](../../../assets/2513616-027-1939a46db9.png) | ![not-support](../../../assets/2513616-028-1939a46db9.png) |
| TLS_ECDHE_ECDSA_WITH_AES_256_CBC_SHA | ![not-support](../../../assets/2513616-029-1939a46db9.png) | ![not-support](../../../assets/2513616-030-1939a46db9.png) | ![not-support](../../../assets/2513616-031-1939a46db9.png) | ![not-support](../../../assets/2513616-032-1939a46db9.png) |
| TLS_ECDHE_RSA_WITH_3DES_EDE_CBC_SHA | ![not-support](../../../assets/2513616-033-1939a46db9.png) | ![not-support](../../../assets/2513616-034-1939a46db9.png) | ![not-support](../../../assets/2513616-035-1939a46db9.png) | ![not-support](../../../assets/2513616-036-1939a46db9.png) |
| TLS_ECDHE_RSA_WITH_AES_128_CBC_SHA | ![not-support](../../../assets/2513616-037-1939a46db9.png) | ![not-support](../../../assets/2513616-038-1939a46db9.png) | ![支持](../../../assets/2513616-039-20c9c60fe8.png) | ![not-support](../../../assets/2513616-040-1939a46db9.png) |
| TLS_ECDHE_RSA_WITH_AES_256_CBC_SHA | ![not-support](../../../assets/2513616-041-1939a46db9.png) | ![not-support](../../../assets/2513616-042-1939a46db9.png) | ![支持](../../../assets/2513616-043-20c9c60fe8.png) | ![not-support](../../../assets/2513616-044-1939a46db9.png) |
| TLS_ECDHE_RSA_WITH_AES_128_GCM_SHA256 | ![not-support](../../../assets/2513616-045-1939a46db9.png) | ![not-support](../../../assets/2513616-046-1939a46db9.png) | ![支持](../../../assets/2513616-047-20c9c60fe8.png) | ![not-support](../../../assets/2513616-048-1939a46db9.png) |
| TLS_ECDHE_ECDSA_WITH_AES_128_GCM_SHA256 | ![not-support](../../../assets/2513616-049-1939a46db9.png) | ![not-support](../../../assets/2513616-050-1939a46db9.png) | ![not-support](../../../assets/2513616-051-1939a46db9.png) | ![not-support](../../../assets/2513616-052-1939a46db9.png) |
| TLS_ECDHE_RSA_WITH_AES_256_GCM_SHA384 | ![not-support](../../../assets/2513616-053-1939a46db9.png) | ![not-support](../../../assets/2513616-054-1939a46db9.png) | ![支持](../../../assets/2513616-055-20c9c60fe8.png) | ![not-support](../../../assets/2513616-056-1939a46db9.png) |
| TLS_ECDHE_ECDSA_WITH_AES_256_GCM_SHA384 | ![not-support](../../../assets/2513616-057-1939a46db9.png) | ![not-support](../../../assets/2513616-058-1939a46db9.png) | ![not-support](../../../assets/2513616-059-1939a46db9.png) | ![not-support](../../../assets/2513616-060-1939a46db9.png) |
| TLS_ECDHE_RSA_WITH_CHACHA20_POLY1305 | ![not-support](../../../assets/2513616-061-1939a46db9.png) | ![not-support](../../../assets/2513616-062-1939a46db9.png) | ![支持](../../../assets/2513616-063-20c9c60fe8.png) | ![not-support](../../../assets/2513616-064-1939a46db9.png) |
| TLS_ECDHE_ECDSA_WITH_CHACHA20_POLY1305 | ![not-support](../../../assets/2513616-065-1939a46db9.png) | ![not-support](../../../assets/2513616-066-1939a46db9.png) | ![not-support](../../../assets/2513616-067-1939a46db9.png) | ![not-support](../../../assets/2513616-068-1939a46db9.png) |
| TLS_RSA_WITH_RC4_128_SHA | ![not-support](../../../assets/2513616-069-1939a46db9.png) | ![not-support](../../../assets/2513616-070-1939a46db9.png) | ![not-support](../../../assets/2513616-071-1939a46db9.png) | ![not-support](../../../assets/2513616-072-1939a46db9.png) |
| TLS_RSA_WITH_AES_128_CBC_SHA256 | ![not-support](../../../assets/2513616-073-1939a46db9.png) | ![not-support](../../../assets/2513616-074-1939a46db9.png) | ![支持](../../../assets/2513616-075-20c9c60fe8.png) | ![not-support](../../../assets/2513616-076-1939a46db9.png) |
| TLS_ECDHE_ECDSA_WITH_RC4_128_SHA | ![not-support](../../../assets/2513616-077-1939a46db9.png) | ![not-support](../../../assets/2513616-078-1939a46db9.png) | ![not-support](../../../assets/2513616-079-1939a46db9.png) | ![not-support](../../../assets/2513616-080-1939a46db9.png) |
| TLS_ECDHE_RSA_WITH_RC4_128_SHA | ![not-support](../../../assets/2513616-081-1939a46db9.png) | ![not-support](../../../assets/2513616-082-1939a46db9.png) | ![not-support](../../../assets/2513616-083-1939a46db9.png) | ![not-support](../../../assets/2513616-084-1939a46db9.png) |
| TLS_ECDHE_ECDSA_WITH_AES_128_CBC_SHA256 | ![not-support](../../../assets/2513616-085-1939a46db9.png) | ![not-support](../../../assets/2513616-086-1939a46db9.png) | ![not-support](../../../assets/2513616-087-1939a46db9.png) | ![not-support](../../../assets/2513616-088-1939a46db9.png) |
| TLS_ECDHE_RSA_WITH_AES_128_CBC_SHA256 | ![not-support](../../../assets/2513616-089-1939a46db9.png) | ![not-support](../../../assets/2513616-090-1939a46db9.png) | ![支持](../../../assets/2513616-091-20c9c60fe8.png) | ![not-support](../../../assets/2513616-092-1939a46db9.png) |
| TLS_AES_128_GCM_SHA256 | ![not-support](../../../assets/2513616-093-1939a46db9.png) | ![not-support](../../../assets/2513616-094-1939a46db9.png) | ![not-support](../../../assets/2513616-095-1939a46db9.png) | ![支持](../../../assets/2513616-096-20c9c60fe8.png) |
| TLS_AES_256_GCM_SHA384 | ![not-support](../../../assets/2513616-097-1939a46db9.png) | ![not-support](../../../assets/2513616-098-1939a46db9.png) | ![not-support](../../../assets/2513616-099-1939a46db9.png) | ![支持](../../../assets/2513616-100-20c9c60fe8.png) |
| TLS_CHACHA20_POLY1305_SHA256 | ![not-support](../../../assets/2513616-101-1939a46db9.png) | ![not-support](../../../assets/2513616-102-1939a46db9.png) | ![not-support](../../../assets/2513616-103-1939a46db9.png) | ![支持](../../../assets/2513616-104-20c9c60fe8.png) |
