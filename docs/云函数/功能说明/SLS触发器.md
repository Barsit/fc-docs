...
- 数据清洗、加工场景
  ...
  ![image](../../../assets/2513638-001-b68302b035.svg)
- 数据投递场景
  
  为数据的目的端落地提供支撑，构建云上大数据产品间的数据管道。
  
  ![image](../../../assets/2513638-002-d34d29e933.svg)
...
![image](../../../assets/2513638-003-f8e4d7d4ec.svg)
...
1. 在函数详情页面的**代码**页签，单击**测试函数**右侧的![image.png](../../../assets/2513638-004-51d4269d35.png)图标，从下拉列表中，选择**配置测试参数**。
