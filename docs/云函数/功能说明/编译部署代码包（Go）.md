...
2. 上传代码包并为函数配置请求处理程序。具体操作方式，请参见[编辑函数](https://help.aliyun.com/zh/functioncompute/fc/user-guide/creating-an-event-function#3cc62eed2e86k)。
  ...
  - 如果编译生成的二进制文件存放在ZIP包的根目录，如下图所示。此时，需要将FC函数**请求处理程序**设置为`main`。![go-main](../../../assets/2513492-001-4542a377dd.png)
  - 如果编译生成的二进制文件没有放到ZIP包的根目录，而是放到例如bin/目录下，如下图所示。此时，**请求处理程序**需要设置为`bin/main`。![gp-bin-main](../../../assets/2513492-002-3f84d54e28.gif)
