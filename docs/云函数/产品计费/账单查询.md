...
![image](../../../assets/2674653-001-5edc2269e0.png)
...
![image](../../../assets/2674653-002-6d31284cfe.png)
...
**定制账单列字段：**单击右侧![image](../../../assets/2674653-003-25794c3169.png)按钮，可以定制需要查看的账单字段。

![image](../../../assets/2674653-004-79313a89d1.png)
...
- 企业管理员MA账号查看成员账号的账单
  ...
  **[账单概览](https://billing-cost.console.aliyun.com/finance/month-bill/account)**或者[账单详情](https://billing-cost.console.aliyun.com/finance/split-bill)页面，通过**企业/组织/账号**查看企业（或组织）下其他账号的订单信息，也可以查看已授权的关联企业实体账号账单信息。
  ...
  ![image](../../../assets/2674653-005-ae13eda3a3.png)
- 主账号查看RAM子账号的账单
...
![image](../../../assets/2674653-006-15acd8f981.png)
